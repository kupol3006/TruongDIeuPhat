...
class Tem extends Component {
    ...
    btnDrop() {
        const element = document.querySelector('.ssInfor1');
        const computedStyle = getComputedStyle(element);
        const svg = document.querySelector('.subInfor1 li svg');
